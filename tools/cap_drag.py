...
Exit 0 only if the cap both moves under drag and returns after release.
"""
...
PORT = int(sys.argv[2]) if len(sys.argv) > 2 else 9391
...
async def main():
    ...
    if dragged <= 20:
        ...
        print("RESULT: PASS -- cap pulls off the axle and springs back.")
